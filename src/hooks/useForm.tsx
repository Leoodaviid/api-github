...
const validators: ValidatorType = {
  ...
  senha: {
    ...
    message: 'Precisa conter 8 caracteres, sendo 1 maiúsculo, 1 minúsculo e 1 número',
  },
...
type typeInput = 'login' | undefined
...
const useForm = (type: typeInput = undefined): Response => {
  ...
  const didNotPassTheRegex = (type: string, valor: any) => !validators[type].regex.test(valor)
